...
INSERT INTO comment(approved,date_of_publication,text,registered_user_id,object_id) VALUES (b'1',DATE'2019-06-26',"Skroz koretkno. Lepo smo se proveli!",1,1);
INSERT INTO comment(approved,date_of_publication,text,registered_user_id,object_id) values(b'1',DATE'2019-06-27','Brate ko bi jos ovde dosao. Ovo je blaga katastrofa!!!!',1,1);
