...
export class SearchComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.searchService.search(this.searchForm.value.city, this.searchForm.value.checkInDate, this.searchForm.value.checkOutDate,
      this.searchForm.value.guests, this.searchForm.value.accTypes,
